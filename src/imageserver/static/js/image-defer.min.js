 ...
 */
"use strict";
var ImageDefer=ImageDefer||{};(function(b){this.version="0.2";this.options={maxLoaded:b.maxLoaded||100,onImageRequested:b.onImageRequested||null,onImageLoaded:b.onImageLoaded||null,onImageUnloaded:b.onImageUnloaded||null,scrollingStopMillis:b.scrollingStopMillis||500,scrollingSkipRate:b.scrollingSkipRate||0.8};
var a={imagesLoaded:0,images:[],maxBucket:0,scrolling:false,resizing:false,scrollInfo:{last:{pos:0,time:0},current:{pos:0,time:0}},scrollChecker:null,resizeChecker:null,lastVisibleBuckets:{start:-1,end:-1}};
...
a.lastVisibleBuckets.end=d.end;}}.bind(this);this.trimImages=function(){if(a.imagesLoaded>this.options.maxLoaded){var i=this.viewportPos(),g=this.getBuckets(i.top,i.height),h=0,d=(a.imagesLoaded-this.options.maxLoaded),f=this,k;
...
if((d-e.time>=this.options.scrollingStopMillis*0.9)&&(this.viewportPos().top===e.pos)){a.scrolling=false;
a.scrollChecker=null;this.requestCallBack(this.lazyLoadImages);if(a.imagesLoaded>this.options.maxLoaded){this.requestCallBack(this.trimImages);
