/*!
	...
	=========  ====  ============================================================
*/
APICodes={SUCCESS:200,SUCCESS_TASK_ACCEPTED:202,INVALID_PARAM:400,REQUIRES_AUTH:401,UNAUTHORISED:403,NOT_FOUND:404,METHOD_UNSUPPORTED:405,ALREADY_EXISTS:409,IMAGE_ERROR:415,INTERNAL_ERROR:500,TOO_BUSY:503};
...
if(c){dd_menu_init(b,c);}});popup_convert_anchor("account_menu",575,380,function(){window.location.reload();
