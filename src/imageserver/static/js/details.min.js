...
}popup_convert_anchor("edit_attrs",575,380,function(){window.location.reload();});popup_convert_anchor("view_stats",575,650);
...
addEventEx("file_delete","click",onDeleteClick);}function onResetClick(){(new Element("span",{html:"Please wait...","class":"disabled"})).replaces($("file_reset"));
