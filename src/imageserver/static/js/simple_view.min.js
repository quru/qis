...
}if(!g&&this.zoomAttrs.level==2){this.reset();return;}}var f=QU.elPosition(this.imageEl),i=QU.evPosition(j).page;
...
/*!
    ...
    along with this program.  If not, see http://www.gnu.org/licenses/
*/
if(!window.QU){QU={supported:([].forEach!==undefined)&&(Object.keys!==undefined)&&(window.addEventListener!==undefined)&&((function(){}).bind!==undefined)&&(window.getComputedStyle!==undefined)};
...
}return d;};QU.evPosition=function(b){var c={x:0,y:0},a={x:0,y:0};if(b.type.indexOf("touch")==0||b.type.indexOf("gesture")==0){if(b.touches&&b.touches[0]){var e=b.touches[0];
