...
RUN groupadd --gid 999 --system $QIS_USER
RUN useradd --comment "Quru Image Server" -g $QIS_USER --groups $WEB_USER --uid 999 --home $QIS_INSTALL_DIR --system --shell /sbin/nologin $QIS_USER
